...
- The TodoList.java in src/main/java/labnine has at least 11 multiple-line Java comment(s)
- The TodoList.java in src/main/java/labnine has at least 11 single-line Java comment(s)
- The TodoList.java in src/main/java/labnine has at least 4 of the `if (` fragment
- The TodoList.java in src/main/java/labnine has at least 5 of the `while (` fragment
- The TodoList.java in src/main/java/labnine has at least 6 of the `ArrayList<TodoListItem>` fragment
- The TodoList.java in src/main/java/labnine has at least 7 of the `Iterator<TodoListItem>` fragment
- The TodoList.java in src/main/java/labnine has exactly 0 of the `Add Your Name Here` fragment
- The TodoList.java in src/main/java/labnine has exactly 0 of the `println(` fragment
- The TodoList.java in src/main/java/labnine has exactly 1 of the `package labnine;` fragment
- The TodoListItem.java in src/main/java/labnine has at least 1 single-line Java comment(s)
- The TodoListItem.java in src/main/java/labnine has at least 15 multiple-line Java comment(s)
- The TodoListItem.java in src/main/java/labnine has exactly 0 of the `Add Your Name Here` fragment
- The TodoListItem.java in src/main/java/labnine has exactly 0 of the `TODO` fragment
- The TodoListItem.java in src/main/java/labnine has exactly 0 of the `println(` fragment
- The TodoListItem.java in src/main/java/labnine has exactly 1 of the `package labnine;` fragment
- The TodoListManager.java in src/main/java/labnine has at least 10 of the `println(` fragment
- The TodoListManager.java in src/main/java/labnine has at least 2 multiple-line Java comment(s)
- The TodoListManager.java in src/main/java/labnine has at least 3 of the `while (` fragment
- The TodoListManager.java in src/main/java/labnine has at least 3 single-line Java comment(s)
- The TodoListManager.java in src/main/java/labnine has at least 5 of the `command.equals` fragment
- The TodoListManager.java in src/main/java/labnine has at least 5 of the `else if (` fragment
- The TodoListManager.java in src/main/java/labnine has at least 6 of the `if (` fragment
- The TodoListManager.java in src/main/java/labnine has exactly 0 of the `Add Your Name Here` fragment
- The TodoListManager.java in src/main/java/labnine has exactly 0 of the `TODO` fragment
- The TodoListManager.java in src/main/java/labnine has exactly 1 of the `package labnine;` fragment
- The command `gradle build` executes correctly
- The file TodoList.java exists in the src/main/java/labnine directory
- The file TodoListItem.java exists in the src/main/java/labnine directory
- The file TodoListManager.java exists in the src/main/java/labnine directory
...
- The reflection.md in writing has exactly 5 of the `heading` tag
...
```
        ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Passed 35/35 (100%) of checks for cs100-F2019-lab9! ┃
        ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
```
git remote add download git@github.com:Allegheny-Computer-Science-100-F2019/cs100-F2019-lab9-starter.git
```
...
5](https://github.com/Allegheny-Computer-Science-100-F2019/cs100-F2019-lab9-starter)
repository and [raise an
issue](https://github.com/Allegheny-Computer-Science-100-F2019/cs100-F2019-lab9-starter/issues).
